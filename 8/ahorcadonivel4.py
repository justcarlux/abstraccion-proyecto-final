...
from palabras import PALABRAS_NIVEL4  # type: ignore

class AhorcadoNivel4:
    def __init__(self, fondo, aleatorio=True):
        ...
        self.palabras = random.sample(PALABRAS_NIVEL4, self.max_rondas) if aleatorio else PALABRAS_NIVEL4[:self.max_rondas]
