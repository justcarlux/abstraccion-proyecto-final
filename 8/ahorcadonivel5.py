...
from palabras import PALABRAS_NIVEL5  # type: ignore

class AhorcadoNivel5:
    def __init__(self, fondo, aleatorio=True):
        ...
        self.palabras = random.sample(PALABRAS_NIVEL5, self.max_rondas) if aleatorio else PALABRAS_NIVEL5[:self.max_rondas]
