...
from palabras import PALABRAS_NIVEL3  # type: ignore

class AhorcadoNivel3:
    def __init__(self, fondo, aleatorio=True):
        ...
        self.palabras = random.sample(PALABRAS_NIVEL3, self.max_rondas) if aleatorio else PALABRAS_NIVEL3[:self.max_rondas]
